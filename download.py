...
def get_parser():
    ...
    parser.add_argument("--token", default=None, type=str, help="access token for private models")
    parser.add_argument("--include", default=None, type=str, help="choose files to download")
    parser.add_argument("--exclude", default=None, type=str, help="choose files not to download")
